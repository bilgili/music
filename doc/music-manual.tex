...
do not require a full \lstinline|DataMap|.  Events are communicated
...
\begin{head}{insertEvent}
  void EventOutputPort::insertEvent (double t, int id)
\end{head}
\begin{parameters}
...
\index{EventHandler}
\begin{head}{EventHandler,operator}
  class EventHandler {
  public:
...
application is supposed to customize \lstinline|EventHandler| by
subclassing it.
...
An \lstinline|IndexMap| is a mapping from local data element indices to
