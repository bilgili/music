...
\begin{code}{Mapping ports to internal data}
{
  ...
  array_data dmap (state_vars, MPI::DOUBLE, n_rank * n_local, n_local);
  out->map (&dmap);
  ...
}
\end{code}
...
receiver calls \lstindent|runtime::tick ()|, an estimate of the values
