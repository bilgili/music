...
During a multi-simulation, each application is assigned its' own
intra-communicator which it is supposed to use in place of
\verb|MPI::COMM_WORLD|.  This communicator is retrieved from the setup
object through a call to the \verb|communicator| method.
