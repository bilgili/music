...
%  \begin{metatext}
    Mikael: What is this?  Should it be documented in the RFC?
%  \end{metatext}
...
get an application wide communicator, and setup ports.
...
setup object through a call to the \lstinline|communicator| method.
...
in place of \lstinline|MPI::COMM_WORLD|.  This communicator can be
used as any ordinary MPI communicator.
...
its method \lstinline|map| is called with a \lstindent|data_map|.
