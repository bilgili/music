\documentclass[a4paper,twosided]{report}
...
\lstinline|linear_index|.  The most general form is the
...
it is structured, and, the type of the data elements.  One subclass of
\lstinline|data_map| is the \lstinline|array_data|, which describes
arrays of data elements.  See example \ref{code:mapping}.
